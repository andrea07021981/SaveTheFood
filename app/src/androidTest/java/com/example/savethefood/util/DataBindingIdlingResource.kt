...
/**
 * Class for testing DATABINDING. Espresso uses a different mechanism than data binding,
 * the Choreographer class, to synchronize its view updates, so it is not aware of data binding changes.
 */
...
/*    fragmentScenario.onFragment {
        this.activity = it.requireActivity()  //TODO deprecated onfragment
    }*/
}
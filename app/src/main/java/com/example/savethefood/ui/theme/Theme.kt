package com.example.savethefood.ui.theme
...
fun SaveTheFoodTheme(
    ...
    // This overrides all the material components colors (is it correct?????????)
    ProvideSaveTheFoodColors(colors) {
        MaterialTheme(
...
object SaveTheFoodTheme {
    val colors: SaveTheFoodColors
        @Composable
        get() = LocalSaveTheFoodColors.current
}

/**
 * SaveTheFood custom Color Palette
 */
@Stable
class SaveTheFoodColors(
    ...
    fun update(other: SaveTheFoodColors) {
    ...
    fun copy(): SaveTheFoodColors = SaveTheFoodColors(
...
@Composable
fun ProvideSaveTheFoodColors(
    colors: SaveTheFoodColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalSaveTheFoodColors provides colorPalette, content = content)
}

private val LocalSaveTheFoodColors = staticCompositionLocalOf<SaveTheFoodColors> {
    error("No SaveTheFoodColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [SaveTheFoodTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
